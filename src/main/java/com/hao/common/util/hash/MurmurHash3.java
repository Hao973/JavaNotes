...
public final class MurmurHash3 {
    ...
    public static void hash128x64(final byte[] data, LongPair out) {
        murmurhash3_x64_128(data, 0, data.length, DEFAULT_SEED, out);
    }

    public static void main(String[] args) {
        MurmurHash3.LongPair outValue = new MurmurHash3.LongPair();
        String testKey = "007体育";
        String[] testKeyList = {"007体育", "-悟空哥哥-", ".top域名", "090乐游团"};
        //public static void murmurhash3_x64_128(byte[] key, int offset, int len, int seed, LongPair out)
        for (String keyValue: testKeyList){
            System.out.println("-----------------------------");
            System.out.println(keyValue);
            MurmurHash3.hash128x64(keyValue.getBytes(), outValue);
            System.out.println("val1: " + outValue.val1);
            System.out.println("val2: " + outValue.val2);
            int val32 = MurmurHash3.murmurhash3_x86_32(keyValue.getBytes(), 0, keyValue.length(), 1);
